...
again:
	...
	case 9:		/* PTRACE_SINGLESTEP */
	{
		...
		if (cp->flags & CS_SETREGS) {
			...
			ps->pr_lwp.pr_reg[REG_V0] = cp->user.u_reg[REG_V0];
			...
			ps->pr_lwp.pr_reg[REG_T7] = cp->user.u_reg[REG_T7];
			ps->pr_lwp.pr_reg[REG_T8] = cp->user.u_reg[REG_T8];
			ps->pr_lwp.pr_reg[REG_T9] = cp->user.u_reg[REG_T9];
			ps->pr_lwp.pr_reg[REG_T10] = cp->user.u_reg[REG_T10];
			ps->pr_lwp.pr_reg[REG_T11] = cp->user.u_reg[REG_T11];
			ps->pr_lwp.pr_reg[REG_T12] = cp->user.u_reg[REG_T12];
			...
			ps->pr_lwp.pr_reg[REG_AT] = cp->user.u_reg[REG_AT];
			...
			ps->pr_lwp.pr_reg[REG_UQ] = cp->user.u_reg[REG_UQ];
			cmd = PCSREG;
...
MakeUser(cstatus_t *cp)
{
	...
	cp->user.u_reg[REG_V0] = ps->pr_lwp.pr_reg[REG_V0];
	...
	cp->user.u_reg[REG_T7] = ps->pr_lwp.pr_reg[REG_T7];
	cp->user.u_reg[REG_T8] = ps->pr_lwp.pr_reg[REG_T8];
	cp->user.u_reg[REG_T9] = ps->pr_lwp.pr_reg[REG_T9];
	cp->user.u_reg[REG_T10] = ps->pr_lwp.pr_reg[REG_T10];
	cp->user.u_reg[REG_T11] = ps->pr_lwp.pr_reg[REG_T11];
	cp->user.u_reg[REG_T12] = ps->pr_lwp.pr_reg[REG_T12];
	...
	cp->user.u_reg[REG_AT] = ps->pr_lwp.pr_reg[REG_AT];
	...
	cp->user.u_reg[REG_UQ] = ps->pr_lwp.pr_reg[REG_UQ];
