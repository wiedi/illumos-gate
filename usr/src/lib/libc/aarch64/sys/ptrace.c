...
again:
	...
	case 9:		/* PTRACE_SINGLESTEP */
	{
		...
		if (cp->flags & CS_SETREGS) {
			...
			ps->pr_lwp.pr_reg[REG_X0] = cp->user.u_reg[REG_X0];
			ps->pr_lwp.pr_reg[REG_X1] = cp->user.u_reg[REG_X1];
			ps->pr_lwp.pr_reg[REG_X2] = cp->user.u_reg[REG_X2];
			ps->pr_lwp.pr_reg[REG_X3] = cp->user.u_reg[REG_X3];
			ps->pr_lwp.pr_reg[REG_X4] = cp->user.u_reg[REG_X4];
			ps->pr_lwp.pr_reg[REG_X5] = cp->user.u_reg[REG_X5];
			ps->pr_lwp.pr_reg[REG_X6] = cp->user.u_reg[REG_X6];
			ps->pr_lwp.pr_reg[REG_X7] = cp->user.u_reg[REG_X7];
			ps->pr_lwp.pr_reg[REG_X8] = cp->user.u_reg[REG_X8];
			ps->pr_lwp.pr_reg[REG_X9] = cp->user.u_reg[REG_X9];
			ps->pr_lwp.pr_reg[REG_X10] = cp->user.u_reg[REG_X10];
			ps->pr_lwp.pr_reg[REG_X11] = cp->user.u_reg[REG_X11];
			ps->pr_lwp.pr_reg[REG_X12] = cp->user.u_reg[REG_X12];
			ps->pr_lwp.pr_reg[REG_X13] = cp->user.u_reg[REG_X13];
			ps->pr_lwp.pr_reg[REG_X14] = cp->user.u_reg[REG_X14];
			ps->pr_lwp.pr_reg[REG_X15] = cp->user.u_reg[REG_X15];
			ps->pr_lwp.pr_reg[REG_X16] = cp->user.u_reg[REG_X16];
			ps->pr_lwp.pr_reg[REG_X17] = cp->user.u_reg[REG_X17];
			ps->pr_lwp.pr_reg[REG_X18] = cp->user.u_reg[REG_X18];
			ps->pr_lwp.pr_reg[REG_X19] = cp->user.u_reg[REG_X19];
			ps->pr_lwp.pr_reg[REG_X20] = cp->user.u_reg[REG_X20];
			ps->pr_lwp.pr_reg[REG_X21] = cp->user.u_reg[REG_X21];
			ps->pr_lwp.pr_reg[REG_X22] = cp->user.u_reg[REG_X22];
			ps->pr_lwp.pr_reg[REG_X23] = cp->user.u_reg[REG_X23];
			ps->pr_lwp.pr_reg[REG_X24] = cp->user.u_reg[REG_X24];
			ps->pr_lwp.pr_reg[REG_X25] = cp->user.u_reg[REG_X25];
			ps->pr_lwp.pr_reg[REG_X26] = cp->user.u_reg[REG_X26];
			ps->pr_lwp.pr_reg[REG_X27] = cp->user.u_reg[REG_X27];
			ps->pr_lwp.pr_reg[REG_X28] = cp->user.u_reg[REG_X28];
			ps->pr_lwp.pr_reg[REG_X29] = cp->user.u_reg[REG_X29];
...
MakeUser(cstatus_t *cp)
{
	...
	cp->user.u_reg[REG_X0] = ps->pr_lwp.pr_reg[REG_X0];
	cp->user.u_reg[REG_X1] = ps->pr_lwp.pr_reg[REG_X1];
	cp->user.u_reg[REG_X2] = ps->pr_lwp.pr_reg[REG_X2];
	cp->user.u_reg[REG_X3] = ps->pr_lwp.pr_reg[REG_X3];
	cp->user.u_reg[REG_X4] = ps->pr_lwp.pr_reg[REG_X4];
	cp->user.u_reg[REG_X5] = ps->pr_lwp.pr_reg[REG_X5];
	cp->user.u_reg[REG_X6] = ps->pr_lwp.pr_reg[REG_X6];
	cp->user.u_reg[REG_X7] = ps->pr_lwp.pr_reg[REG_X7];
	cp->user.u_reg[REG_X8] = ps->pr_lwp.pr_reg[REG_X8];
	cp->user.u_reg[REG_X9] = ps->pr_lwp.pr_reg[REG_X9];
	cp->user.u_reg[REG_X10] = ps->pr_lwp.pr_reg[REG_X10];
	cp->user.u_reg[REG_X11] = ps->pr_lwp.pr_reg[REG_X11];
	cp->user.u_reg[REG_X12] = ps->pr_lwp.pr_reg[REG_X12];
	cp->user.u_reg[REG_X13] = ps->pr_lwp.pr_reg[REG_X13];
	cp->user.u_reg[REG_X14] = ps->pr_lwp.pr_reg[REG_X14];
	cp->user.u_reg[REG_X15] = ps->pr_lwp.pr_reg[REG_X15];
	cp->user.u_reg[REG_X16] = ps->pr_lwp.pr_reg[REG_X16];
	cp->user.u_reg[REG_X17] = ps->pr_lwp.pr_reg[REG_X17];
	cp->user.u_reg[REG_X18] = ps->pr_lwp.pr_reg[REG_X18];
	cp->user.u_reg[REG_X19] = ps->pr_lwp.pr_reg[REG_X19];
	cp->user.u_reg[REG_X20] = ps->pr_lwp.pr_reg[REG_X20];
	cp->user.u_reg[REG_X21] = ps->pr_lwp.pr_reg[REG_X21];
	cp->user.u_reg[REG_X22] = ps->pr_lwp.pr_reg[REG_X22];
	cp->user.u_reg[REG_X23] = ps->pr_lwp.pr_reg[REG_X23];
	cp->user.u_reg[REG_X24] = ps->pr_lwp.pr_reg[REG_X24];
	cp->user.u_reg[REG_X25] = ps->pr_lwp.pr_reg[REG_X25];
	cp->user.u_reg[REG_X26] = ps->pr_lwp.pr_reg[REG_X26];
	cp->user.u_reg[REG_X27] = ps->pr_lwp.pr_reg[REG_X27];
	cp->user.u_reg[REG_X28] = ps->pr_lwp.pr_reg[REG_X28];
	cp->user.u_reg[REG_X29] = ps->pr_lwp.pr_reg[REG_X29];
