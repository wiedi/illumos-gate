...
#define	DMAI_FLAGS_WINMASK	0x0f
#define	DMAI_FLAGS_WINEN(x)	(1 << (x))
#define	DMAI_FLAGS_INUSE	0x10
#define	DMAI_FLAGS_PGPFN	0x20
...
extern ddi_dma_impl_t *pci_dma_allocmp(dev_info_t *dip, dev_info_t *rdip,
	int (*waitfp)(caddr_t), caddr_t arg, uint_t sgllen);
extern void pci_dma_freemp(dev_info_t *dip, dev_info_t *rdip, ddi_dma_impl_t *mp);
...
extern int pci_dma_map(pci_t *pci_p, ddi_dma_req_t *req, ddi_dma_impl_t *mp);
...
extern void pci_vmem_do_free(iommu_t *iommu_p, void *base_addr, size_t npages,
	int vmemcache);
void pci_dma_unmap(pci_t *pci_p, ddi_dma_impl_t *mp);
