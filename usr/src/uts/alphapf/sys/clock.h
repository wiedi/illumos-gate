...
extern void pcc_hrtimeinit(uint64_t cpu_freq_hz);
extern void pcc_sync_master(processorid_t);
extern void pcc_sync_slave(void);
...
#define	YRBASE		52	/* 1900 - what year 0 in chip represents */
