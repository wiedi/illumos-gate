...
extern hrtime_t pcc_gethrtimeunscaled(void);
extern void pcc_scalehrtime(hrtime_t *);
extern uint64_t pcc_unscalehrtime(hrtime_t);
extern hrtime_t pcc_gethrtime(void);
