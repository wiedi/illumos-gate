...
#ifndef _ASM
typedef struct alpha_pcb hw_pcb_t;
...
typedef struct pcb {
	...
	uintptr_t	pcb_self;	/* Physical Address of self */
} pcb_t;

#endif /* ! _ASM */

#define	PCB_HW_FLAGS_FEN	0x0000000000000001
#define	PCB_HW_FLAGS_IMB	0x0000000100000000
#define	PCB_HW_FLAGS_PME	0x4000000000000000
